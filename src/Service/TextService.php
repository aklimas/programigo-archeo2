...
class TextService
{
     ...
     * @return string
     */
    public function replaceTitles($tekst, $strtolower = true)
    {
        // $tekst = strtolower($tekst);
        // tablice znaków
        $search = [' ', '<', '/', '\'', '&', '%', 'ć', 'ś', 'ą', 'ż', 'ó', 'ł', 'ś', 'ź', 'ń', 'ę'];
        $replace = ['_', '', '-', '-', 'and', 'procent', 'c', 's', 'a', 'z', 'o', 'l', 's', 'z', 'n', 'e'];
        if (true == $strtolower) {
     ...
     * @return mixed
     */
    public function getDataMask($args)
    {
        $data = htmlspecialchars($args['data']);
        $data = trim(preg_replace('/\s\s+/', ' ', $data));
        preg_match_all($args['mask'],
            $data,
    ...
    public function clearName($text, bool $strtolower = true, string $space = '-'): string
    {
        $replace = [
            'ъ' => '-', 'Ь' => '-', 'Ъ' => '-', 'ь' => '-',
        ...
        if (true == $strtolower) {
            $text = strtolower($text); // zamienia wszystkie litery na małe
        }

        return $text; // zwraca przekształcony tekst
    }
     ...
     * @return string
     */
    public function shortNameWithoutSpace($tekst, $strtolower = true)
    {
        $tekst = $this->clearName($tekst, $strtolower);
        $tekst = strtr($tekst, [' ' => '-']);
